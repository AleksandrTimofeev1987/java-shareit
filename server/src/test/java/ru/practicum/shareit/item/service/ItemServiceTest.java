...
public class ItemServiceTest {
    ...
    private static final Pageable PAGE = PageRequest.of(0 / 10, 10, SORT_BY_ID);
    ...
    public void testGetAllItemsByUserId() {
        ...
        Mockito
                .when(itemRepository.findByOwnerIdOrderById(1L, PAGE))
        ...
        List<ItemResponseDto> result = service.getAllItemsByUserId(1L, 0, 10);
    ...
    public void testSearchItemByText() {
        ...
        Mockito
                .when(itemRepository.searchByNameOrDescription("search", PAGE))
                .thenReturn(foundItems);
        ...
        List<ItemResponseDto> result = service.searchItemsByText(1L, "search", 0, 10);
        Assertions.assertEquals(listToGet, result);
    }
}
